...
<br>
<img src="../assets/01.main-banner.ru.png" alt="DV.net Banner" width="100%">
<br>
<br>
...
> #### 🔓 **Open Source**  — Любой может проверить безопасность

> #### 💰 **Без комиссий** — Только сетевая комиссия

> #### 🔐 **Некастодиальный** — Полный контроль над ключами

> #### ⚙️ **Self‑hosted** — Или используйте облачную версию
...
### 🎯 Основные
- ✅ **Без комиссий** — платите только сети
...
Данный проект выпущен под лицензией [MIT](LICENSE).
